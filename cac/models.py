...
class Curso(models.Model):
    ...
    #portada = models.ImageField(update_to="imagenes/", null=True, verbose_name= "Portada")
    # MANY TO ONE
    categoria = models.ForeignKey(Categoria, on_delete=models.CASCADE)
    #estudiantes = models.ManyToManyField(Estudiante) # Crea una tabla intermedia automática
